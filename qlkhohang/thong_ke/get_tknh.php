            ...
            <div class="main">
                ...
                <div class="container overflow-hidden text-center" style="margin-top: 20px;">
                    <div class="containertk" id="statisticSelection" style="margin-top: 20px;">
                        <h2 style="margin-bottom: 20px; color: gold; font-weight: bold;">Xem Thống Kê NHẬP HÀNG</h2>
                        ...
                        <button type="button" class="btn btn-warning" id="btnViewReport" style="margin-top: 20px;">Xem Báo Cáo</button>
