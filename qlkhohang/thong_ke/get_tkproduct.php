            ...
            <div class="main">
                ...
                <div class="container overflow-hidden text-center" style="margin-top: 20px;">
                    <div class="containertk" id="statisticSelection" style="margin-top: 20px;">
                        <h2 style="margin-bottom: 20px; color: blue; font-weight: bold;">Xem Thống Kê SP BÁN RA</h2>
                        ...
                        <button type="button" class="btn btn-primary" id="btnViewReport" style="margin-top: 20px;">Xem Báo Cáo</button>
                ...
                <script>
                    $(document).ready(function() {
                        $('#btnViewReport').click(function() {
                            ...
                            $.ajax({
                                url: 'process_product_report.php',
                                type: 'POST',
                                data: {
                                    month: selectedMonth,
                                    year: selectedYear
